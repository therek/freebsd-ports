...
#
# $FreeBSD: ports/Mk/bsd.ruby.mk,v 1.79 2002/05/24 10:57:30 knu Exp $
#
...
RUBY_DISTVERSION?=	${RUBY_VER}-2002.05.03
RUBY_PATCHFILES?=	ruby-${RUBY_DISTVERSION}-2002.05.05.diff.bz2 \
			ruby-${RUBY_VER}-2002.05.05-2002.05.23.diff.bz2
RUBY_PORTVERSION?=	${RUBY_VERSION}.2002.05.23
.else
RUBY_VERSION?=		1.6.7
